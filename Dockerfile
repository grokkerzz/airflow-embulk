...
RUN apt-get -y install build-essential python3.7 python3.7-dev && update-alternatives --install /usr/bin/python3 python3 /usr/bin/python3.7 1 && apt-get remove python3-apt -yqq
